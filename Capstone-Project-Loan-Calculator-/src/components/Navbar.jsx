...
const Navbar = () => {
  return (
    <nav className='navbar' style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '0 20px' ,background:'#E5F2FF',fontFamily: 'Roboto, sans-serif',fontWeight:'bolder',color:'#381664',borderBottom:"1px solid black"}}>
      <h1 
